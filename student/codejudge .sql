...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2017 at 05:17 PM
...
INSERT INTO `problems1` (`sl`, `name`, `text`, `input`, `output`, `time`, `event_id`) VALUES
(1, 'n+2', 'INPUT \r\nN\r\nOUTPUT N+2', '2', '4', 1000, 1),
(2, 'jQuery tabSlideOut Demo', '1000', '2', '3', 1444, 2),
(3, 'mark', 'oop', 'ooooo', '22', 2000, 1),
(5, 'fang', '222000', '0', '1000', 100, 2);
...
--
-- AUTO_INCREMENT for table `problems1`
--
ALTER TABLE `problems1`
...
--
-- Constraints for table `problems1`
--
ALTER TABLE `problems1`
  ADD CONSTRAINT `event` FOREIGN KEY (`event_id`) REFERENCES `event` (`event_id`);
